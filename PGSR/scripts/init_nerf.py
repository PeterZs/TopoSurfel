...
for scene in scenes:
    ...
    if scene == "materials":
        common_args = "--quiet --num_cluster 12 --voxel_size 0.01 --max_depth 5.0 --eval"
    elif scene == "ship" or scene == "ficus" or scene == "drums":
        common_args = "--quiet --num_cluster 100 --voxel_size 0.01 --max_depth 5.0 --eval"
    else:
        common_args = "--quiet --num_cluster 1 --voxel_size 0.01 --max_depth 5.0 --eval"
