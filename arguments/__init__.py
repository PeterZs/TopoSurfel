...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # True: always use the initial mesh to guide normal orientation; False: switch to the current mesh after iteration 100.
        self.use_initial_mesh_for_normal_flip = True
        self.mesh_guidance_dist_ratio = 3.0
        self.mesh_guidance_normal_cos_thresh = 0.5  # 60-degree angle

        # MILO-style mesh depth/normal regularization (only applied when mesh render is available)
        self.mesh_depth_weight = 0.05
        self.mesh_normal_weight = 0.0
