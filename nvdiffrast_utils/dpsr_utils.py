#  Code from https://github.com/autonomousvision/shape_as_points/blob/main/src/utils.py
...
def load_ckpt_local(path, device='cpu'):
    '''Load a module dictionary from local path.
    
    Args:
        path (str): path to saved model
    '''
    print('=> Loading checkpoint from local path...')
